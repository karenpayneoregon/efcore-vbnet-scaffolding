...
Imports DataGridViewExample.Extensions
Imports DataGridViewExample.FormClasses
Imports DataGridViewExample.Models

''' <summary>
''' Note that columns are predefined in CustomersDataGridView
''' along with property to bind too.
''' </summary>
Public Class Form1
